...
%begin sample on two cylinders
%cylinder is placed on x-y plane horizontally, one is y=1.2 one is y=-1.2
...
testsubject = surf(Z*10,Y+1.2,X+1,c); 
...
set(legend1,...
    'Position',[0.102044409271376 0.732738098076413 0.287241305014338 0.203571422894796]);
%end- draw cylinder